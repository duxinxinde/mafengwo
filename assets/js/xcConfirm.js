...
(function($){
	...
	window.wxc.xcConfirm = function(popHtml, type, options) {
		...
		var $txtBox = $("<div>").addClass("txtBox").css("background","url(./images/img1.png)");//弹窗内容主体区
		var $btnArea = $("<div>").addClass("btnArea");//按钮区域
		
		var $ok = $("<a>").addClass("sgBtn").addClass("ok").text("取消").css('display','none');//确定按钮
		var $cancel = $("<a>").addClass("sgBtn").addClass("cancel").text("取消");//取消按钮
		var $input = $("<input>").addClass("inputBox");//输入框
		var $clsBtn = $("<a>").addClass("clsBtn").html("×").css('font-size','23px').css('color','#ff9d00');//关闭按钮
